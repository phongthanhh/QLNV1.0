...
function editInfo(id) {
    ...
    const upName = getEl("upName").value = staffthen[id].name
    const upEmail = getEl("upEmail").value = staffthen[id].email
    const upPass = getEl("upPass").value = staffthen[id].password
    const upDate = getEl("upDate").value = staffthen[id].date
    const upSelect = getEl("upSelect").value = staffthen[id].posi
    const upPay = getEl("upPay").value = staffthen[id].pay
    const upTime = getEl("upTime").value = staffthen[id].time

    const getUser = getEl('upUser');
    console.log('PhongThanh 🚀 ~> getUser', getUser)
