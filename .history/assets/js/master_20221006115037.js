...
function fetchData() {
    ...
    console.log('PhongThanh 🚀 ~> localStaff', localStaff)
        //   kiểm tra tồn tại
    if (localStaff) {
        ...
        for (let i = 0; i < arrLocal.length; i++) {
            ...
            mapData(JSON.parse(localEmplList)); in cái danh sách hiện tại ra màn hình.
            renderEmployee();
        }
...
mapData = (data) => {
    for (i = 0; i < data.length; i++) {
        ...
        // Chuyển thành đối tượng nhân viên mới
