...
function renderInfo(staffs) {
    ...
    staffs.forEach(staff => {
        ...
        <td>${staff.pay}$</td>
        <td class="text-warning">${staff.posiLabel}</td>
        <td>
            <div class="action">
...
addUserbtn.addEventListener('click', function() {
    ...
    modalAddEl.setAttribute('aria-modal', false)
    modalAddEl.setAttribute('class', 'modal fade')
    modalAddEl.removeAttribute('role')
