...
function editInfo(id) {
    ...
    cfUpdate.addEventListener('click', () => {
        const closeModalEl = document.querySelector('#modalUpdate .btn-close')
...
function closeModel(id) {
    const test = document.querySelector(`#${id} .btn-close `).click()
    console.log('PhongThanh 🚀 ~> test', test)
}