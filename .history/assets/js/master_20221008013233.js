...
function renderInfo(staffs) {
    ...
    staffs.forEach((staff, index) => {
        ...
        <td>
            <div class="action">
                <a class="action__edit" data-bs-toggle="modal" data-bs-target="#modalUpdate"href="javascript:void(0);" onclick="editInfo(${index})" ><i class="bx bx-edit-alt "></i> </a>
                <a class="action__del" href="javascript:void(0);" onclick="delInfo(${index})" ><i class="bx bx-trash "></i> </a>
             </div>
        </td>
    </tr>
        `
...
function editInfo(id) {
    ...
    let getUser = document.getElementById('upUser');
    getUser = staffs[id].userName
