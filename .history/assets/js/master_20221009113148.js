    ...
    staffs.forEach((staff, index) => {
        ...
        <td>
            <div class="action">
                ...
                <a class="action__del" data-bs-toggle="modal" data-bs-target="#modalDel" href="javascript:void(0);" data-id="${staffId}"onclick="delInfo(${staffId})"  ><i class="bx bx-trash "></i> </a>
             </div>
        </td>
    </tr>
        `
