...
// List Input Update
const getUserUp = getEl('addusername');
const getNameUp = getEl('addName');
const getEmailUp = getEl('addEmail');
const getPassUp = getEl('addPassword');
const getDateUp = getEl('addDate');
const getPosiUp = getEl('addPosi');
const getPayUp = getEl('addPay');
const getTimeUp = getEl('addTime');
