    ...
    staffs.forEach((staff, index) => {
        ...
        <td>
            <div class="action">
                ...
                <a class="action__del" data-bs-toggle="modal" data-bs-target="#modalDel"href="javascript:void(0);" onclick="delInfo(${staffId})" ><i class="bx bx-edit-alt "></i> </a>

                <a class="action__del" href="javascript:void(0);" onclick="delInfo(${staffId})" data-toggle="modal" data-target="#modalDel" ><i class="bx bx-trash "></i> </a>
             </div>
        </td>
    </tr>
        `
