...
function renderInfo(staffs) {
    ...
    staffs.forEach(staff => {
        ...
        <td class="text-warning">${staff.calcSalary()}</td>
        <td>
            <div class="action">
...
addUserbtn.addEventListener('click', function() {
    const closeModalEl = document.getElementsByClassName('btn-close')[0]
    console.log('Tai Vo ==>', closeModalEl)
    closeModalEl.setAttribute("onclick", "alert('blah');")
