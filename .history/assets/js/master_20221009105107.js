...
function renderInfo(data) {
    data = data || staffs;
    console.log('PhongThanh 🚀 ~> data', data)
    ...
    staffs.forEach((staff, index) => {
        ...
        <td>
            <div class="action">
                ...
                <a class="action__del" href="javascript:void(0);" onclick="delInfo(${staffId})" ><i class="bx bx-trash "></i> </a>
             </div>
        </td>
    </tr>
        `
...
function delInfo(id) {
    ...
    localStorage.setItem("staff", JSON.stringify(staffthen));
    console.log('PhongThanh 🚀 ~> staffthen', staffthen)
    renderInfo(staffs)
}