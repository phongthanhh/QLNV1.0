...
function editInfo(id) {
    console.log('PhongThanh 🚀 ~> id', id)
    const staffthen = localStorage.getItem("staff") ? JSON.parse(localStorage.getItem("staff")) : []
    console.log(staffthen[id])
    const upUser = document.getElementById("upUser").value = staffthen[id].userName
    const upName = document.getElementById("upName").value = staffthen[id].userName
    const upEmail = document.getElementById("upEmail").value = staffthen[id].userName
    const upPass = document.getElementById("upPass").value = staffthen[id].userName
    const upDate = document.getElementById("upDate").value = staffthen[id].userName
    const upSelect = document.getElementById("upSelect").value = staffthen[id].userName
    const upPay = document.getElementById("upPay").value = staffthen[id].userName
    const upTime = document.getElementById("upTime").value = staffthen[id].userName
...
function delInfo(id) {
    ...
    const modalDel = document.querySelector()
        // const staffthen = localStorage.getItem("staff") ? JSON.parse(localStorage.getItem("staff")) : []
