...
function editInfo(id) {
    ...
    const upName = document.getElementById("upName").value = staffthen[id].name
    const upEmail = document.getElementById("upEmail").value = staffthen[id].email
    const upPass = document.getElementById("upPass").value = staffthen[id].password
    const upDate = document.getElementById("upDate").value = staffthen[id].date
    const upSelect = document.getElementById("upSelect").value = staffthen[id].posi
    const upPay = document.getElementById("upPay").value = staffthen[id].pay
    const upTime = document.getElementById("upTime").value = staffthen[id].time
