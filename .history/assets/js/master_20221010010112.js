...
function editInfo(id) {
    ...
    getEl("upUser").value = staffthen[id].userName
    getEl("upName").value = staffthen[id].name
    getEl("upEmail").value = staffthen[id].email
    getEl("upPass").value = staffthen[id].password
    getEl("upDate").value = staffthen[id].date
    getEl("upSelect").value = staffthen[id].posi
    getEl("upPay").value = staffthen[id].pay
    getEl("upTime").value = staffthen[id].time

    getEl('upUser').setAttribute("disabled", true);

    const cfUpdate = getEl('cfUpdate')
    cfUpdate.addEventListener('click', () => {
        const upUser = getEl("upUser").value = staffthen[id].userName
        const upName = getEl("upName").value
        const upEmail = getEl("upEmail").value
        const upPass = getEl("upPass").value
        const upDate = getEl("upDate").value
        const upSelect = getEl("upSelect").value
        const upPay = getEl("upPay").value
        const upTime = getEl("upTime").value
    })
